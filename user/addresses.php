...
$sql_all_address = $db->query("SELECT *
  ...
  addresses.address_id = users_addresses.address_id WHERE user_id={$userID}");
...
$sql_other_addresses = $db->query("SELECT *
  FROM addresses INNER JOIN users_addresses ON 
  addresses.address_id = users_addresses.address_id WHERE user_id={$userID} AND active=0");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Your Address(es) - Halfcarry</title>
</head>
...
<body>
      ...
      <div class="dashboard-main-section">
        <div class="dashboard-main-container">
          ...
          <div class="addresses-container">
            ...
            ?>
              <div style="flex: 1; display: flex; align-items: center; justify-content: center; height: 200px; font-size: 1.2rem">
  ...
  <script>
    function setToDefaultAddress(addressId) {
      ...
      $.post("./controllers/set-default-address.php", {
        submit: true,
        aid: addressId
      }, function(response) {
    ...
    function deleteAddress(addressId) {
      if (confirm("Are you sure you want to delete this address?")) {
        ...
        $.post("./controllers/delete-address.php", {
          submit: true,
          aid: addressId
        }, function(response) {
          response = JSON.parse(response);
