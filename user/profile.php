            ...
            <form id="edit-form">
              ...
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="fname" id="fname" class="form-input" placeholder=" " value="<?php echo ($user_details['first_name']) ?>" required />
                  <label for="fname">First name</label>
                </div>
              </div>
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="lname" id="lname" class="form-input" placeholder=" " value="<?php echo ($user_details['last_name']) ?>" required />
              ...
              <div class="form-groupings">
                <div class="password-form-group-container first">
                  <div class="password-form-group">
                    <input type="password" name="oldpwd" id="oldpwd" class="password-form-input" placeholder=" " required />
                ...
                <div class="password-form-group-container first">
                  <div class="password-form-group">
                    <input type="password" name="newpwd" id="newpwd" class="password-form-input" placeholder=" " required />
                ...
                <div class="password-form-group-container">
                  <div class="password-form-group">
                    <input type="password" name="cnewpwd" id="cnewpwd" class="password-form-input" placeholder=" " required />
