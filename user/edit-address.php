            ...
            <form id="edit-form">
              ...
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="rname" id="rname" class="form-input" placeholder=" " value="<?php echo $address_details['recipient_name'] ?>" required />
                  <label for="rname">Recipient's full name</label>
                </div>
              </div>
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="number" name="rphoneno" id="rphoneno" class="form-input" placeholder=" " value="<?php echo $address_details['recipient_phone_no'] ?>" required />
                  <label for="rphoneno">Recipient's phone number</label>
                </div>
              </div>
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="daddress" id="daddress" class="form-input" value="<?php echo $address_details['delivery_address'] ?>" placeholder=" " required />
                  <label for="address">Delivery address</label>
                </div>
              </div>
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="ainfo" id="ainfo" class="form-input" value="<?php echo $address_details['additional_info'] ?>" placeholder=" " required />
                  <label for="ainfo">Additional info</label>
                </div>
              </div>
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="city" id="city" class="form-input" value="<?php echo $address_details['city_name'] ?>" placeholder=" " required />
