...
<?php
$clientID = "176009817869-5b0iq35i3lf14sm6chdqbcvmuk3buflu.apps.googleusercontent.com";
$secret = "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";
...
$gclient->setRedirectUri('http://localhost/courses/oauth/login.php');
