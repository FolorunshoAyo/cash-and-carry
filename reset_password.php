...
<head>
  ...
  <title>Reset your password - Halfcarry</title>
</head>
          ...
          <div class="form-groupings">
            <div class="password-form-group-container first">
              <div class="password-form-group">
                <input type="password" name="pwd" id="pwd" class="password-form-input" placeholder=" " required />
            ...
            <div class="password-form-group-container">
              <div class="password-form-group">
                <input type="password" name="cpwd" id="cpwd" class="password-form-input" placeholder=" " required />
