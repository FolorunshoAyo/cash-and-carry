...
<head>
  ...
  <title>Register and start saving - HalfCarry</title>
</head>
    ...
    <section class="form-section">
      <div class="form-container">
        <form id="registeration-form">
          ...
          <div class="form-groupings">
            <div class="form-group-container">
              ...
              <div class="form-group-container">
                <div class="form-group animate">
                  <input type="text" name="mobileno" id="mobileno" class="form-input" placeholder=" " required />
        ...
        <div class="existing-account-block">
          ...
          <a href="./login">Sign In <i class="fa fa-arrow-right"></i></a>
        </div>
      </div>
    </section>
  </div>
