...
if (isset($_GET['sid']) && !empty($_GET['sid'])) {
    ...
    $sql_shop_details = $db->query("SELECT * FROM stores WHERE id={$sid}");

    $shop_details = $sql_shop_details->fetch_assoc();

    $shop_owner_full_name = $shop_details['owner_name'];

    $shop_owner_full_name_splitted = explode(" ", $shop_owner_full_name);
} else {
...
<head>
    ...
    <title>Edit Shop - Halfcarry Agent</title>
</head>
    ...
    <div class="dash-wrapper">
        ...
        <section class="page-wrapper">
            ...
            <div class="form-wrapper">
                <h2 class="form-title">Edit Store</h2>
                            ...
                            <div class="form-group-container">
                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="text" name="sname" id="sname" class="form-input" placeholder=" " value="<?= $shop_details['name'] ?>" required />
                                ...
                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="text" name="fname" id="fname" class="form-input" placeholder=" " value="<?= $shop_owner_full_name_splitted[1] ?>" required />
                                ...
                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="text" name="lname" id="lname" class="form-input" placeholder=" " value="<?= $shop_owner_full_name_splitted[0] ?>" required />
                                        <label for="lname">Shop Owner Last Name</label>
                                    </div>
                                </div>

                                <div class="form-group-container">
                                    <h3 class="static-label">Shop Owner Email</h3>
                                    <span class="static-email"><?= $shop_details['owner_email'] ?></span>
                                </div>

                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="number" name="phoneno" id="phoneno" class="form-input" placeholder=" " value="<?= $shop_details['owner_phone'] ?>" required />
                                ...
                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="text" name="reg_no" id="reg_no" class="form-input" placeholder=" " value="<?= $shop_details['reg_no'] ?>" required />
    ...
    <script>
        ...
        validation
            ...
            .onSuccess((event) => {
                ...
                formData.append("sid", <?php echo $sid ?>);


                //SENDING FORM DATA TO THE SERVER
                $.ajax({
                    type: "post",
                    url: "controllers/edit_store.php",
                    data: formData,
                    contentType: false,
                    processData: false,
                    dataType: "json",
                        ...
                        setTimeout(() => {
                            if (response.success === 1) {
                                ...
                                Swal.fire({
                                    title: "Store updated",
                                    icon: "success",
                                    text: `You've updated store - ${response.store_name} successfully`,
