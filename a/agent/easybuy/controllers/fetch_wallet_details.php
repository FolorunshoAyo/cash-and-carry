<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($wid)){
            ...
            $sql_get_wallet_details = $db->query("SELECT easybuy_agent_wallets.total_amount, products.name, product_meta.daily_payment FROM easybuy_agent_wallets INNER JOIN products ON easybuy_agent_wallets.product_id = products.product_id INNER JOIN product_meta ON easybuy_agent_wallets.product_id = product_meta.product_id WHERE wallet_id='$wid'");
