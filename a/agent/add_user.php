...
<head>
    ...
    <title>Add a new user - Halfcarry Admin</title>
</head>
       ...
       ?>
        <section class="page-wrapper">
            ...
            <div class="form-wrapper">
                <h2 class="form-title">Register a New User</h2>
                    ...
                    <form id="user-upload-form">
                        <div class="form-groupings">
                            <div class="form-group-container">
                                ...
                                <div class="form-group-container">
                                    <div class="form-group animate">
                                        <input type="text" name="uname" id="uname" class="form-input"
                                            placeholder=" " required />
                        ...
                        setTimeout(() => {
                            if (response.success === 1) {
                                ...
                                Swal.fire({
                                    title: "User Added",
                                    icon: "success",
                                    text: `You've added user ${response.user_name} successfully`,
