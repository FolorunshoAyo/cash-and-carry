...
<head>
    ...
    <title><?= $shop_details['name'] ?> Products - Halfcarry Agent</title>
</head>
    ...
    <div class="dash-wrapper">
        ...
        <section class="page-wrapper">
            <div class="table-wrapper">
                <h2 class="table-title">All <?= $shop_details['name'] ?> Products</h2>
                    ...
                    <table id="products-table" class="main-table">
                        ...
                        <tbody>
                            ...
                            $sql_products = $db->query("SELECT stores.name as store_name, products.* , product_categories.*
                                ...
                                INNER JOIN stores ON products.store_id = stores.id) WHERE stores.agent_id = {$agent_id} AND store_id = {$sid}");
                                    ...
                                    <td>
                                        <div class="product-details-container">
                                            <div class="product-img-container">
                                                ...
                                                ?>
                                                <img src="<?= $url ?>assets/images/<?php echo ($first_image[0]); ?>" alt="Product Image" />
                                            </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" data-dd-path="<?php echo ($products_count); ?>">
                                                ...
                                                <a class="dropdown-menu__link deleteEl" href="javascript:void(0)" onclick="deleteProduct('<?= $row_product['product_id'] ?>')" data-productId="<?php echo ($row_product['product_id']); ?>">Delete
                                                    product</a>
                                            </div>
                                        </div>
                                    </td>
